...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/01 18:20:38 by sokwon            #+#    #+#             */
/*   Updated: 2022/10/02 14:34:56 by sokwon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#define LEFT_TOP_VERTEX 'o'
#define LEFT_BOTTOM_VERTEX 'o'
#define RIGHT_TOP_VERTEX 'o'
#define RIGHT_BOTTOM_VERTEX 'o'
