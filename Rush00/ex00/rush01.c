...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/01 18:23:07 by sokwon            #+#    #+#             */
/*   Updated: 2022/10/01 18:25:03 by sokwon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#define LEFT_TOP_VERTEX '/'
#define LEFT_BOTTOM_VERTEX '\\'
#define RIGHT_TOP_VERTEX '\\'
#define RIGHT_BOTTOM_VERTEX '/'
